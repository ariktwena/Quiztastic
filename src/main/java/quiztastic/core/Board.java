...
public class Board {
    ...
    private  String scoreLeftAlignFormatRow1 = "| %-30s | %-30s | %-30s | %-30s | %-30s | %-30s |%n";
    private  String scoreLeftAlignFormatRow2 = "| %-30s | %-30s | %-30s | %-30s | %-30s | %-30s |%n";
    private  String scoreLeftAlignFormatRow3 = "| %-30s | %-30s | %-30s | %-30s | %-30s | %-30s |%n";
    private  String scoreLeftAlignFormatRow4 = "| %-30s | %-30s | %-30s | %-30s | %-30s | %-30s |%n";
    private  String scoreLeftAlignFormatRow5 = "| %-30s | %-30s | %-30s | %-30s | %-30s | %-30s |%n";
